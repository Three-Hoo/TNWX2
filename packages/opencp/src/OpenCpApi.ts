...
export class OpenCpApi {
   ...
   * 获取预授权码
   */
  public static async getPreAuthCode(apiConfig: ApiConfig) {
   ...
   */
  public static async setSessionInfo(apiConfig: ApiConfig, preAuthCode: string, authType = 0, appId?: Array<number>) {
    let accessToken: AccessToken = await OpenCpAccessTokenApi.getAccessToken(apiConfig, AccessTokenType.SUITE_TOKEN)
   ...
   */
  public static async getPermanentCode(apiConfig: ApiConfig, authCode: string) {
    let accessToken: AccessToken = await OpenCpAccessTokenApi.getAccessToken(apiConfig, AccessTokenType.SUITE_TOKEN)
   ...
   */
  public static async getAuthInfo(apiConfig: ApiConfig, authCorpId: string, permanentCode: string) {
    let accessToken: AccessToken = await OpenCpAccessTokenApi.getAccessToken(apiConfig, AccessTokenType.SUITE_TOKEN)
   ...
   */
  public static async getAdminList(apiConfig: ApiConfig, authCorpId: string, agentId: string) {
    let accessToken: AccessToken = await OpenCpAccessTokenApi.getAccessToken(apiConfig, AccessTokenType.SUITE_TOKEN)
   ...
   */
  public static async searchContact(apiConfig: ApiConfig, authCorpId: string, queryWord: string, queryType: 0, agentId?: string, offset?: number, limit?: number) {
   ...
   */
  public static async upload(apiConfig: ApiConfig, mediaType: string, filePath: string) {
    let accessToken: AccessToken = await OpenCpAccessTokenApi.getAccessToken(apiConfig)
   ...
   */
  public static async contactIdTranslate(apiConfig: ApiConfig, authCorpId: string, mediaIdList: Array<string>, outputFileName?: string) {
    let accessToken: AccessToken = await OpenCpAccessTokenApi.getAccessToken(apiConfig, AccessTokenType.PROVIDER_TOKEN)
   ...
   * @param jobId 异步任务id
   */
  public static async getBatchResult(apiConfig: ApiConfig, jobId: string) {
    let accessToken: AccessToken = await OpenCpAccessTokenApi.getAccessToken(apiConfig, AccessTokenType.PROVIDER_TOKEN)
   ...
   */
  public static async sortContact(apiConfig: ApiConfig, authCorpId: string, userIdList: Array<string>, sortType?: number) {
    let accessToken: AccessToken = await OpenCpAccessTokenApi.getAccessToken(apiConfig, AccessTokenType.PROVIDER_TOKEN)
